...
export const AdminPickupDriverDetailScreen = ({ route, navigation }: any) => {
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.text}>Vehicle Type: {data.vehicle_type || 'Not specified'}</Text>
        </View>
        <View style={styles.row}>
          <Ionicons name="card-outline" size={20} color="#666" style={styles.icon} />
          <Text style={styles.text}>License: {data.license_number || 'Not specified'}</Text>
        </View>
      </View>
      ...
      <View style={styles.actions}>
        <TouchableOpacity style={styles.actionBtn} onPress={handleToggle}>
          ...
          <Text style={styles.actionBtnText}>
            {data.current_status === 'active' ? 'Deactivate Driver' : 'Activate Driver'}
          </Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
