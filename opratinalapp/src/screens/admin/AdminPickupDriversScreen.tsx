...
import { getPickupDrivers, togglePickupDriverStatus } from '../../api/adminApi';
import { LoadingView } from '../../components/LoadingView';
import { EmptyState } from '../../components/EmptyState';
import { Ionicons } from '@expo/vector-icons';

export const AdminPickupDriversScreen = ({ navigation }: any) => {
  ...
  const loadData = async () => {
    try {
      const res = await getPickupDrivers();
  ...
  const handleToggle = async (id: number) => {
    try {
      await togglePickupDriverStatus(id);
      loadData();
    } catch (e) {
  ...
  if (loading) return <LoadingView message="Loading Pickup Drivers..." />;
    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        <View>
          ...
          <Text style={styles.detail}>{item.user?.mobile_number}</Text>
      ...
      <View style={styles.cardFooter}>
        ...
        <View style={styles.actions}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('AdminPickupDriverFormScreen', { id: item.id })} style={[styles.actionBtn, styles.editBtn]}>
            <Text style={[styles.actionBtnText, { color: '#FFF' }]}>Edit</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('AdminPickupDriverDetailScreen', { id: item.id })} style={[styles.actionBtn, styles.viewBtn]}>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.searchRow}>
        ...
        <TouchableOpacity style={styles.addBtn} onPress={() => navigation.navigate('AdminPickupDriverFormScreen')}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<EmptyState title="No Pickup Drivers Found" />}
