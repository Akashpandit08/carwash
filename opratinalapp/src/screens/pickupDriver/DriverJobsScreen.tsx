    ...
    <View style={styles.container}>
      <FlatList
        ...
        renderItem={({ item }) => (
          <BookingCard 
            booking={item} 
            onPress={() => navigation.navigate('DriverJobDetailScreen', { bookingId: item.id })} 
          />
        )}
        ListEmptyComponent={<EmptyState title="No Assigned Jobs" message="You have no pickups/deliveries right now." />}
