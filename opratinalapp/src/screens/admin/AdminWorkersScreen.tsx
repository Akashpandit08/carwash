...
import { getWorkers, toggleWorkerStatus } from '../../api/adminApi';
import { LoadingView } from '../../components/LoadingView';
import { EmptyState } from '../../components/EmptyState';
import { Ionicons } from '@expo/vector-icons';

export const AdminWorkersScreen = ({ navigation }: any) => {
    ...
    <View style={styles.card}>
      ...
      <View style={styles.cardFooter}>
        ...
        <View style={styles.actions}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('AdminWorkerFormScreen', { id: item.id })} style={[styles.actionBtn, styles.editBtn]}>
            <Text style={[styles.actionBtnText, { color: '#FFF' }]}>Edit</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('AdminWorkerDetailScreen', { id: item.id })} style={[styles.actionBtn, styles.viewBtn]}>
  ...
  return (
    <SafeScreen style={styles.container}>
      <View style={styles.searchRow}>
        ...
        <TouchableOpacity style={styles.addBtn} onPress={() => navigation.navigate('AdminWorkerFormScreen')}>
